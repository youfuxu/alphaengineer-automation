...
const HOOK = '💬 Comment "CHECKLIST" and I\'ll send you my free Faceless YouTube Starter Checklist — the exact 4-phase system, zero fluff.';
...
for (const post of data.posts) {
  if (post.caption.includes('Comment "CHECKLIST"')) continue;
